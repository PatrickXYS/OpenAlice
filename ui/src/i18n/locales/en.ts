...
export const en = {
  ...
  market: {
    ...
    insidersTape: 'Insider Tape',
    insidersTapeSubtitle: 'Daily Form 4 cache for the fixed {{universe}} universe.',
    insidersTapeUniverse: '{{universe}} · {{count}} symbols',
    insidersTapePartialErrors: 'Could not load Form 4 for: {{symbols}}',
    insidersRefresh: 'Refresh now',
    insidersRefreshing: 'Refreshing…',
    insidersStatBuys: 'Buys',
    insidersStatSells: 'Sells',
    insidersStatActive: 'Names active',
    insidersStatOfUniverse: 'of {{count}} in universe',
    insidersStatNet: 'Buy − sell $',
    insidersStatNetHint: 'Open-market notional',
    insidersNotableBuys: 'Notable buys',
    insidersNotableBuysHint: '≥ {{min}}',
    insidersAllSymbols: 'All symbols',
    insidersSortWhen: 'Sort by date',
    insidersSortNotional: 'Sort by size',
    ...
    insidersTitle: 'Insider trades (Form 4)',
    insidersInfo: 'SEC Form 4 filings. Open market = BUY/SELL. Awards, gifts, option exercises are non-market (shown under All).',
    insidersAll: 'All',
    insidersMarket: 'Open market',
    insidersNonMarket: 'non-market',
    insidersBuy: 'Buy',
    insidersSell: 'Sell',
    insidersEmpty: 'No insider transactions found.',
    insidersWhen: 'When',
    insidersSide: 'Side',
    insidersNotional: 'Notional',
    insidersShares: 'Shares @ px',
    insidersPerson: 'Insider',
    insidersRole: 'Role',
    colSymbol: 'Symbol',
    colPrice: 'Price',
    colChangePct: 'Chg %',
